...
* [CH2 Web Proxy](CH2/Programing/WebProxy)<br>因为做过CSAPP的proxy lab所以原理很简单，但是给的python模板一堆坑，各种细节问题，尤其是自动发200 OK完全不考虑304 Not Modified，无语了。另外强调下要用给的网站测试，因为这是特意用的http 80端口，现在常用网站基本都是https 443端口了，哭哭，愣了半天才发觉端口不对。（注意这个lab的可选都写在一起了，看似没加post是因为直接把请求转发了，是get还是post都无所谓，都可以处理，而且get和post也没啥本质区别，不过没有找到测试网站）
